...
function _isArray(objectOrArray) {
    return (0, lodash_1.isArray)(objectOrArray);
}
/**
...
function arrayize(objectOrArray) {
    ...
    const tuples = (0, lodash_1.toPairs)(objectOrArray);
 ...
 */
function getPropertiesFromExpression(expression, test = () => true) {
    let properties = [];
    let lhs;
 ...
 */
function iterateLogicalExpression({ onExit, // onExit(propertyOrOperator, value, builder)
